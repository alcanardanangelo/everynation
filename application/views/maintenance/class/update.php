<div class="row">
  <div class="col-lg-12">
    ...
    <?php echo form_open('maintenance/class/update/' . $result['class_id']); ?>
    <div class="row">
      <div class="col-lg-4">
        <div class="form-group">
          <label for="school_name">Class Name</label>
          <input type="text" class="form-control" name="class_name" id="class_name" value="<?php echo $result['class_name']; ?>">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="3" name="class_description" id="class_description"><?php echo $result['class_descro[']; ?></textarea>
