<div class="row">
  <div class="col-lg-12">
    ...
    <?php echo form_open('maintenance/victory-group-leader/add'); ?>
    <div class="row">
      <div class="col-lg-4">
        <div class="form-group">
          <label for="victory_group_leader_firstname">Firstname</label>
          <input type="text" class="form-control" name="victory_group_leader_firstname" id="victory_group_leader_firstname">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="victory_group_leader_lastname" id="victory_group_leader_lastname">
